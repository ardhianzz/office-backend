...
class MigrasiTabelDetailKeberangkatanLpd extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('elpd_trs')->create('detail_keberangkatan_lpd', function (Blueprint $table) {
    ...
    {
        Schema::connection('elpd_trs')->dropIfExists('detail_keberangkatan_lpd');
    }
}
